...
import 'package:touchtech_competitions/models/ladder_stage.dart';
import 'package:touchtech_competitions/models/pool.dart';
  ...
  group('Fixtures Results Filtering Tests', () {
    ...
    group('Header Display Logic Tests', () {
      ...
      test('Headers hidden when pool filter applied', () {
        ...
        final showHeader = multipleStages.length > 1 && selectedPoolId.isEmpty;
        expect(showHeader, isFalse);
      });
    });
