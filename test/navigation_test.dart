...
void main() {
  group('Navigation Tests', () {
    ...
    group('Competition Navigation Flow', () {
      ...
      Widget createCompetitionApp() {
        return MaterialApp(
          ...
          routes: {
            ...
            '/divisions': (context) => DivisionsView(event: testEvent, season: '2024'),
          },
        );
      }

      testWidgets('Should navigate from Competitions to Event Detail', (WidgetTester tester) async {
      ...
      testWidgets('Should navigate from Event Detail to Divisions', (WidgetTester tester) async {
        await tester.pumpWidget(MaterialApp(
          theme: FITTheme.lightTheme,
      ...
      testWidgets('Should maintain navigation stack integrity', (WidgetTester tester) async {
            ...
            body: Navigator(
              onGenerateRoute: (settings) {
                switch (settings.name) {
                  case '/divisions':
                    return MaterialPageRoute(
                      builder: (context) => DivisionsView(event: testEvent, season: '2024'),
                    );
                  default:
                    return MaterialPageRoute(
                      builder: (context) => EventDetailView(event: testEvent),
    ...
    group('Bottom Navigation Bar Visibility', () {
      testWidgets('Should always show bottom navigation bar', (WidgetTester tester) async {
        await tester.pumpWidget(createTestApp());
      ...
      testWidgets('Should not show duplicate bottom navigation bars', (WidgetTester tester) async {
        await tester.pumpWidget(createTestApp());
